...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38683785146824592739)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683785450203592739)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683785799615592739)
,p_page_template_id=>wwv_flow_imp.id(38683785146824592739)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683786026541592739)
,p_page_template_id=>wwv_flow_imp.id(38683785146824592739)
