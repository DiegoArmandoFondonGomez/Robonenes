...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38683776533353592735)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683776880741592735)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683777160139592735)
,p_page_template_id=>wwv_flow_imp.id(38683776533353592735)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683777420870592735)
,p_page_template_id=>wwv_flow_imp.id(38683776533353592735)
