...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683855719826592770)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683856082765592770)
,p_plug_template_id=>wwv_flow_imp.id(38683855719826592770)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683856346728592771)
,p_plug_template_id=>wwv_flow_imp.id(38683855719826592770)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683856694640592771)
,p_plug_template_id=>wwv_flow_imp.id(38683855719826592770)
,p_name=>'Sub Regions'
