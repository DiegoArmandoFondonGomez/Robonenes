...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683791896136592742)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683792127113592742)
,p_plug_template_id=>wwv_flow_imp.id(38683791896136592742)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683792450685592742)
,p_plug_template_id=>wwv_flow_imp.id(38683791896136592742)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683792735410592742)
,p_plug_template_id=>wwv_flow_imp.id(38683791896136592742)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683793064874592742)
,p_plug_template_id=>wwv_flow_imp.id(38683791896136592742)
,p_name=>'Sub Regions'
