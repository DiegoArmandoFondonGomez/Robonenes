...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683825129061592756)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683825464396592757)
,p_plug_template_id=>wwv_flow_imp.id(38683825129061592756)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683825796262592757)
,p_plug_template_id=>wwv_flow_imp.id(38683825129061592756)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683826011561592757)
,p_plug_template_id=>wwv_flow_imp.id(38683825129061592756)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683826353725592757)
,p_plug_template_id=>wwv_flow_imp.id(38683825129061592756)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683826627231592757)
,p_plug_template_id=>wwv_flow_imp.id(38683825129061592756)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
