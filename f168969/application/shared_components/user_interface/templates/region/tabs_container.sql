...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683868232512592776)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683868566391592776)
,p_plug_template_id=>wwv_flow_imp.id(38683868232512592776)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683868819898592776)
,p_plug_template_id=>wwv_flow_imp.id(38683868232512592776)
,p_name=>'Tabs'
