...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38683755954167592724)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683756228178592725)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683756584676592725)
,p_page_template_id=>wwv_flow_imp.id(38683755954167592724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683756814538592725)
,p_page_template_id=>wwv_flow_imp.id(38683755954167592724)
