...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683848656559592767)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683848956986592767)
,p_plug_template_id=>wwv_flow_imp.id(38683848656559592767)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683849266427592767)
,p_plug_template_id=>wwv_flow_imp.id(38683848656559592767)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683849535752592767)
,p_plug_template_id=>wwv_flow_imp.id(38683848656559592767)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683849807390592767)
,p_plug_template_id=>wwv_flow_imp.id(38683848656559592767)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683850199094592768)
,p_plug_template_id=>wwv_flow_imp.id(38683848656559592767)
,p_name=>'Sub Regions'
