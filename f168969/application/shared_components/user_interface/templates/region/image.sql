...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683828663658592758)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683828986075592758)
,p_plug_template_id=>wwv_flow_imp.id(38683828663658592758)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683829258579592759)
,p_plug_template_id=>wwv_flow_imp.id(38683828663658592758)
,p_name=>'Sub Regions'
