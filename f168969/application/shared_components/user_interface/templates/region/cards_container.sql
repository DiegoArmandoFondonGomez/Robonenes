...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683798979701592745)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683799273472592745)
,p_plug_template_id=>wwv_flow_imp.id(38683798979701592745)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683799552937592745)
,p_plug_template_id=>wwv_flow_imp.id(38683798979701592745)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683799842190592745)
,p_plug_template_id=>wwv_flow_imp.id(38683798979701592745)
,p_name=>'Sub Regions'
