...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683820502008592754)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683820820791592755)
,p_plug_template_id=>wwv_flow_imp.id(38683820502008592754)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683821113658592755)
,p_plug_template_id=>wwv_flow_imp.id(38683820502008592754)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683821409322592755)
,p_plug_template_id=>wwv_flow_imp.id(38683820502008592754)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683821701660592755)
,p_plug_template_id=>wwv_flow_imp.id(38683820502008592754)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683822047377592755)
,p_plug_template_id=>wwv_flow_imp.id(38683820502008592754)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683822335400592755)
,p_plug_template_id=>wwv_flow_imp.id(38683820502008592754)
,p_name=>'Sub Regions'
