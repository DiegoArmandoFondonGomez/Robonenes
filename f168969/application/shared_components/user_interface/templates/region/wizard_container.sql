...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683875968581592779)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683876236534592780)
,p_plug_template_id=>wwv_flow_imp.id(38683875968581592779)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683876553151592780)
,p_plug_template_id=>wwv_flow_imp.id(38683875968581592779)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683876820363592780)
,p_plug_template_id=>wwv_flow_imp.id(38683875968581592779)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683877161012592780)
,p_plug_template_id=>wwv_flow_imp.id(38683875968581592779)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683877455608592780)
,p_plug_template_id=>wwv_flow_imp.id(38683875968581592779)
