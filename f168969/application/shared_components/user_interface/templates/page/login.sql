...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38683766553787592730)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683766895432592730)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683767136327592730)
,p_page_template_id=>wwv_flow_imp.id(38683766553787592730)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683767480020592731)
,p_page_template_id=>wwv_flow_imp.id(38683766553787592730)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683767796501592731)
,p_page_template_id=>wwv_flow_imp.id(38683766553787592730)
,p_name=>'Body Footer'
