...
@@workspace/credentials/app_168969_push_notifications_credentials_2.sql
...
@@application/shared_components/files/icon_bckg_light_1_png.sql
@@application/shared_components/files/icon_light_2_png.sql
@@application/shared_components/files/wondra_otf.sql
@@application/shared_components/files/nuevafokinabejtia_svg.sql
@@application/shared_components/files/serenabackgroundlanding_png.sql
...
@@application/shared_components/user_interface/lovs/lov_tasks.sql
...
@@application/shared_components/user_interface/templates/region/login_serena.sql
...
@@application/shared_components/security/authentications/serena_auth.sql
