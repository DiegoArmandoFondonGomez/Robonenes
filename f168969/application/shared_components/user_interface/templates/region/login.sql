...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683853255401592769)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683853529920592769)
,p_plug_template_id=>wwv_flow_imp.id(38683853255401592769)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683853835029592769)
,p_plug_template_id=>wwv_flow_imp.id(38683853255401592769)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683854114565592769)
,p_plug_template_id=>wwv_flow_imp.id(38683853255401592769)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683854414877592770)
,p_plug_template_id=>wwv_flow_imp.id(38683853255401592769)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683854768441592770)
,p_plug_template_id=>wwv_flow_imp.id(38683853255401592769)
,p_name=>'Sub Regions'
