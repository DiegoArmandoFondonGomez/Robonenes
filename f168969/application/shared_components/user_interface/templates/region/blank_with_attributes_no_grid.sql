...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683793206042592742)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683793592364592743)
,p_plug_template_id=>wwv_flow_imp.id(38683793206042592742)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683793807812592743)
,p_plug_template_id=>wwv_flow_imp.id(38683793206042592742)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683794178635592743)
,p_plug_template_id=>wwv_flow_imp.id(38683793206042592742)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683794457301592743)
,p_plug_template_id=>wwv_flow_imp.id(38683793206042592742)
,p_name=>'Sub Regions'
