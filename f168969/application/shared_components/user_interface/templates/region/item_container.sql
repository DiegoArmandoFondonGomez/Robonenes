...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38683850774704592768)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683851073627592768)
,p_plug_template_id=>wwv_flow_imp.id(38683850774704592768)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683851335207592768)
,p_plug_template_id=>wwv_flow_imp.id(38683850774704592768)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683851637634592768)
,p_plug_template_id=>wwv_flow_imp.id(38683850774704592768)
,p_name=>'Button Start'
